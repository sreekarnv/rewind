...
export default defineConfig({
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          { text: "Overview", link: "/USER_GUIDE" },
          {
            ...
            link: "/USER_GUIDE#capture-management",
          },
          ...
          { text: "Alert System", link: "/USER_GUIDE#alert-system" },
          {
            ...
            link: "/USER_GUIDE#email-notifications",
          },
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: "Architecture",
            link: "/DEVELOPER_GUIDE#architecture-overview",
          },
          {
            text: "Development Setup",
            link: "/DEVELOPER_GUIDE#development-setup",
          },
          { text: "Core Concepts", link: "/DEVELOPER_GUIDE#core-concepts" },
          {
            text: "Adding Features",
            link: "/DEVELOPER_GUIDE#adding-new-features",
          },
      ...
      {
        text: "Configuration",
        items: [{ text: "Email Setup", link: "/EMAIL_SETUP_GUIDE" }],
      },
    ],
  ...
  head: [
    ["link", { rel: "icon", type: "image/svg+xml", href: "/rewind/logo.svg" }],
  ],
});
